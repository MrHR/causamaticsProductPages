...
namespace causamaticsProductPages.Controllers
{
    ...
    public class CmsController : Controller
    {
        ...
        [Route("emotion")]
        public async Task<IActionResult> Emotion(Guid id, bool draft = false)
        {
            try
            {
                var model = await _loader.GetPageAsync<EmotionArchive>(id, HttpContext.User, draft);
